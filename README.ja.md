...
<p align="center">
  <a href="https://evolink.ai/openclaw?utm_source=github&utm_medium=readme&utm_campaign=openclaw-manager">ウェブサイト</a> •
  <a href="https://evolink.ai/openclaw?utm_source=github&utm_medium=readme&utm_campaign=openclaw-manager">ダウンロード</a> •
...
1. **API キー** — AI モデル用（[EvoLink](https://evolink.ai?utm_source=github&utm_medium=readme&utm_campaign=openclaw-manager) で取得）
...
| 必要なもの | 取得方法 |
|-----------|---------|
| **EvoLink API キー** | [evolink.ai](https://evolink.ai/signup?utm_source=github&utm_medium=readme&utm_campaign=openclaw-manager)utm_medium=readme[evolink.ai](https://evolink.ai/signup?utm_source=github&utm_medium=readme&utm_campaign=openclaw-manager)utm_campaign=openclaw-manager) → ダッシュボード → API Keys |
...
[EvoLink](https://evolink.ai/openclaw?utm_source=github&utm_medium=readme&utm_campaign=openclaw-manager) 経由で Claude を使用すると、**公式価格より約30%お得**。

- 同じモデル、同じ品質
- コード変更不要
- OpenClaw Manager ですぐに使える

> 🔥 期間限定オファー。[節約額を計算 →](https://evolink.ai/openclaw#pricing?utm_source=github&utm_medium=readme&utm_campaign=openclaw-manager)
