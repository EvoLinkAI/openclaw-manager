...
<p align="center">
  <a href="https://evolink.ai/openclaw?utm_source=github&utm_medium=readme&utm_campaign=openclaw-manager">官網</a> •
  <a href="https://evolink.ai/openclaw?utm_source=github&utm_medium=readme&utm_campaign=openclaw-manager">下載</a> •
  <a href="#安裝指南">安裝指南</a> •
  <a href="#支援的通訊渠道">渠道</a> •
  <a href="#模型">模型</a>
</p>
...
1. **一個 API Key** — 用於 AI 模型（從 [EvoLink](https://evolink.ai?utm_source=github&utm_medium=readme&utm_campaign=openclaw-manager) 取得）
...
| 需要什麼 | 在哪取得 |
|---------|---------|
| **EvoLink API Key** | [evolink.ai](https://evolink.ai/signup?utm_source=github&utm_medium=readme&utm_campaign=openclaw-manager)utm_medium=readme[evolink.ai](https://evolink.ai/signup?utm_source=github&utm_medium=readme&utm_campaign=openclaw-manager)utm_campaign=openclaw-manager) → 控制台 → API Keys |
...
透過 [EvoLink](https://evolink.ai/openclaw?utm_source=github&utm_medium=readme&utm_campaign=openclaw-manager) 使用 Claude，**比官方定價節省約 30%**。

- 相同模型，相同品質
- 無需修改程式碼
- OpenClaw Manager 開箱即用

> 🔥 限時優惠。[計算你的節省 →](https://evolink.ai/openclaw#pricing?utm_source=github&utm_medium=readme&utm_campaign=openclaw-manager)
